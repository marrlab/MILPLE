...
from FullMILModelMDS import FullMILModel
...
for patientname in tqdm(list(cam_masks.keys())):
    ...
    with open("../MIL/training/patient_imgs_mds/" + patientname + ".dat", 'rb') as f:
    # with open("" +patientname + ".dat", 'rb') as f:
...
with open("mds_insertion_" + WHAT + ".dat", "wb") as f:
